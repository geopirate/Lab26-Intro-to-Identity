...
namespace Lab26George.Controllers
{
    public class PlayerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlayerID,Title,Height,Health,AttackPower,GameMaster")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlayerID,Title,Height,Health,AttackPower,GameMaster")] Player player)
        {
